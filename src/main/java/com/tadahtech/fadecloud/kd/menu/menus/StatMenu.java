...
public class StatMenu extends Menu {
    ...
    public StatMenu(PlayerInfo info) {
        super(ChatColor.LIGHT_PURPLE + "Statistics");
        this.info = info;
    }
    ...
    protected Button[] setUp() {
        ...
        ItemStack kills_deaths = new ItemBuilder(new ItemStack(Material.DIAMOND_SWORD))
          ...
          .lore(" ",
            ChatColor.GRAY + "Kills: " + ChatColor.GREEN + info.getKills(),
            ChatColor.GRAY + "Deaths: " + ChatColor.GREEN + info.getDeaths(),
            ChatColor.GRAY + "K/D Ratio: " + ChatColor.GREEN + kd)
          .build();
        ItemStack creeper = new ItemBuilder(new ItemStack(Material.SKULL_ITEM))
          ...
          .lore(" ",
            ChatColor.GRAY + "Wins: " + ChatColor.GREEN + info.getWins(TeamType.CREEPER),
            ChatColor.GRAY + "Level: " + ChatColor.GREEN + info.getLevel(TeamType.CREEPER))
          .build();
        ItemStack skeleton = new ItemBuilder(new ItemStack(Material.SKULL_ITEM))
          ...
          .lore(" ",
            ChatColor.GRAY + "Wins: " + ChatColor.GREEN + info.getWins(TeamType.SKELETON),
            ChatColor.GRAY + "Level: " + ChatColor.GREEN + info.getLevel(TeamType.SKELETON))
          .build();
        ItemStack zombie = new ItemBuilder(new ItemStack(Material.SKULL_ITEM))
          ...
          .lore(" ",
            ChatColor.GRAY + "Wins: " + ChatColor.GREEN + info.getWins(TeamType.ZOMBIE),
            ChatColor.GRAY + "Level: " + ChatColor.GREEN + info.getLevel(TeamType.ZOMBIE))
          .build();
        ItemStack enderman = new ItemBuilder(new ItemStack(Material.SKULL_ITEM))
          ...
          .lore(" ",
            ChatColor.GRAY + "Wins: " + ChatColor.GREEN + info.getWins(TeamType.ENDERMAN),
            ChatColor.GRAY + "Level: " + ChatColor.GREEN + info.getLevel(TeamType.ENDERMAN))
          .build();
        buttons[13] = new ShowButton(kills_deaths);
        buttons[21] = new ShowButton(creeper);
        buttons[23] = new ShowButton(zombie);
        buttons[28] = new ShowButton(skeleton);
        buttons[30] = new ShowButton(enderman);
        return buttons;
    }
