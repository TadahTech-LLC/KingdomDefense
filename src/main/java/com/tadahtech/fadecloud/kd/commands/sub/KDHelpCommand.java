...
public class KDHelpCommand implements SubCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        String buff = color +  ChatColor.BOLD + ChatColor.STRIKETHROUGH + "=";
        for (int i = 0; i < 10; i++) {
            builder.append(buff);
        }
        ...
        builder.append(line);
        builder.append(ChatColor.RESET).append(color).append(ChatColor.BOLD).append(ChatColor.STRIKETHROUGH).append("[");
        ...
        builder.append("\n");
        builder.append(color).append("Made By: ").append(ChatColor.GRAY).append("TadahTech || Timothy");
        builder.append("\n \n");
